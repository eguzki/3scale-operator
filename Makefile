...
ifndef OPERATORCOURIER
	...
	cd $(PROJECT_PATH)/deploy/olm-catalog && operator-courier --verbose push 3scale-operator-master/ $(APPLICATION_REPOSITORY_NAMESPACE) 3scale-operator-master $(MANIFEST_RELEASE) "basicb =="
